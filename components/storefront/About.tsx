...
export default function About() {
  return (
    <main className="flex items-center justify-center py-16 lg:py-24 lg:px-24 2xl:px-48 2xl:py-32 max-md:px-10">
      <div className="flex flex-col items-start justify-center lg:max-w-7xl 2xl:max-w-screen-2xl w-full gap-10">
        <div className="lg:flex gap-10 lg:items-start lg:justify-center w-full">
          ...
          />
          <div className="text-justify flex lg:max-w-lg flex-col mt-16 lg:mt-0 gap-6">
              <h1 className="font-bold text-2xl lg:text-3xl text-primary max-md:text-center">
                What We Offer
              </h1>
